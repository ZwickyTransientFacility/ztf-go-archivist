...
type Alert struct {
	...
	// object identifier or name
		...
		Fp_hists *UnionNullArrayFp_hist
...
const AlertAvroCRC64Fingerprint = "\xbc\x10\x1b\v＂B"
...
func writeAlert(r *Alert, w io.Writer) error {
	...
	err = writeUnionNullArrayFp_hist( r.Fp_hists, w)
	if err != nil {
		return err
	}
...
func (r *Alert) Get(i int) types.Field {
	...
	case 6:
			...
			r.Fp_hists = NewUnionNullArrayFp_hist()
